...
sleep 2
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
printf '\e[0;32mINSTALLING XRAY CORE...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
printf '\e[0;32mDONE INSTALLING XRAY CORE\e[0m'
clear
#install Trojan GO
printf '\e[0;32mINSTALLING TROJAN GO...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/trojan-go.sh && chmod +x trojan-go.sh && screen -S trojan-go ./trojan-go.sh
printf '\e[0;32mDONE INSTALLING TROJAN GO\e[0m'
clear
#install ohp-server
printf '\e[0;32mINSTALLING OHP...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
printf '\e[0;32mDONE INSTALLING OHP PORT\e[0m'
clear
#install websocket
printf '\e[0;32mINSTALLING WEBSOCKET...\e[0m'
wget https://raw.githubusercontent.com/NiL070/xcode/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
printf '\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m'
clear
#install SET-BR
printf '\e[0;32mINSTALLING SET-BR...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/xcode/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
