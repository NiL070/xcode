...
xraycore_link="https://github.com/NiL070/XrayCoreChanger/releases/download/Xray-CoreMod_v1.7.2-1/Xray-linux-64-v1.7.2-1.zip"
...
wget -O port-trojan "https://raw.githubusercontent.com/NiL070/xcode/main/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/NiL070/xcode/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/NiL070/xcode/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/NiL070/xcode/main/menu/xraay.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
